...
function normaliseItinerary(
  ...
  return {
    ...
    segments: itinerary.flights.map((seg) => ({
      origin: seg.departure_airport.name,
      originCode: seg.departure_airport.id,
      destination: seg.arrival_airport.name,
      destinationCode: seg.arrival_airport.id,
      departureTime: extractTime(seg.departure_airport.time),
      arrivalTime: extractTime(seg.arrival_airport.time),
      airline: seg.airline,
      airlineLogo: seg.airline_logo,
      flightNumber: seg.flight_number,
      durationMinutes: seg.duration,
      cabin: seg.travel_class,
    })),
